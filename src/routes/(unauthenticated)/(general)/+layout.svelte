...
<div class="flex flex-col min-h-screen justify-between">
	<NavBar extraClass="max-[768px]:justify-between" extraClassInner="justify-between">
		...
		<div slot="mobile-menu">
			...
			{#if $isOpenMobileMenu}
				<ul
					class="menu-mobile__content absolute right-0 top-full bg-white rounded-lg shadow-xl mt-[0px] z-50 w-[200px] max-h-[300px]"
				>
					<li class="p-[8px] menu-content">
	...
	<Footer extraClass="justify-between">
		<div class="h-full text-center flex flex-col">
			<a href="/" class="footer-content">Terms of Use</a>
			<a href="/" class="footer-content">Privacy Policy</a>
		</div>
		<div class="h-full text-center flex flex-col">
			<a href="/" class="footer-content">About Us</a>
			<a href="/" class="footer-content">Affiliate</a>
		</div>
	</Footer>
</div>
